...
API_ID = int(environ.get('24336610', ''))
API_HASH = environ.get('1b4f44a32897fc4b01c5863d3c76f600', '')
BOT_TOKEN = environ.get('7639264807:AAFO2vtUr3_nf52-ccpIkGgvhR-48exspIc', "")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1933087805').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6289907631').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002112659478'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002056018561').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002056018561') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002056018561')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002842271522')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://hackertapas:t8yC6tJP1HNAwGC9@cluster0.sgfklc5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/tapas_manager') # Support Chat Link Without https:// or @
